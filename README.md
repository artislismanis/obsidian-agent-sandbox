...
- **Human-in-the-loop writes.** The **Vault-wide writes** dropdown (Scoped only / Reviewed / Full) controls writes outside the workspace dir; pick **Reviewed** and every such write pops an Obsidian modal with a diff, approve or reject per operation.
